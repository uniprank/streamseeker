...
from streamseeker.console.logging.filters import STREAMSEEKER_FILTER
from streamseeker.console.logging.formatters import FORMATTERS
...
class IOFormatter(logging.Formatter):
    ...
    def format(self, record: LogRecord) -> str:
        ...
        if not STREAMSEEKER_FILTER.filter(record):
